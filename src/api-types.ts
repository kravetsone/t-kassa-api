...
export interface components {
	schemas: {
		 ...
		 *
		 *
		 *     С 01.09.2025 для чеков с маркированными товарами обязательна передача часовой зоны места расчета (тег 1011). По умолчанию — Москва. Для изменения напишите на acq_help@tbank.ru.
		 *      */
		MarkCode: {
			/**

...
export interface components {
    schemas: {
        ...
        Init_FULL: {
             ...
             *       (Несопоставимые значения rebillId или Recurrent с переданным значением OperationInitiatorType)
             *      */
            DATA?: components["schemas"]["Common"] | components["schemas"]["T-Pay"] | components["schemas"]["YandexPay"] | components["schemas"]["LongPay"];
        ...
        InitPayments: {
            ...
            paymentItems?: [
                components["schemas"]["PaymentItem"]
            ];
            /** @description Объект с информацией о платежных системах */
            paymentSystems?: components["schemas"]["T-Payweb"] | components["schemas"]["TbankFps"];
        };
        /** Пример ответа */
        ...
        FinishAuthorize_FULL: {
             ...
             * @enum {string}
             */
            Source?: "cards" | "beeline" | "mts" | "tele2" | "megafon" | "einvoicing" | "webmoney" | "YandexPay";
        ...
        FinishAuthorize_SDK: {
             ...
             * @enum {string}
             */
            Source?: "cards" | "einvoicing" | "Installment" | "qrsbp" | "Bnpl" | "MC" | "RC" | "VC" | "TinkoffPay" | "TinkoffWallet" | "YandexPay" | "UP";
            /** @description JSON объект, содержащий дополнительные
             *     параметры в виде “ключ”:”значение”.
             *     Данные параметры будут переданы на страницу
             *     оплаты (в случае ее кастомизации).
             ...
             *     превышать 20
             *      */
            DATA?: components["schemas"]["3DSv2SDK"] | {
                [key: string]: string | undefined;
            };
            /**
             * Format: email
        ...
        With3DSv2APP: components["schemas"]["FinishAuthorize"] & Record<string, never> & {
            /**
        ...
        With3DSv2BRW: components["schemas"]["FinishAuthorize"] & Record<string, never> & {
            /**
             * @description Уникальный идентификатор транзакции,генерируемый 3DS-Server, обязательный параметр для 3DS второй версии
             *
        ...
        Confirm: {
            ...
            Amount?: number;
            /** @description JSON-объект с данными чека. Обязателен, если подключена онлайн-касса */
            Receipt?: components["schemas"]["Receipt_FFD_12"] | components["schemas"]["Receipt_FFD_105"];
        ...
        Items_Params: {
             ...
             * @enum {string}
             */
            Source?: "BNPL" | "cards" | "Installment" | "MirPay" | "qrsbp" | "SberPay" | "TinkoffPay" | "YandexPay";
            /**
        ...
        "Confirm-2": {
             ...
             * @enum {string}
             */
            Status: "NEW" | "AUTHORIZING" | "AUTHORIZED" | "AUTH_FAIL" | "CANCELED" | "CHECKING" | "CHECKED" | "COMPLETING" | "COMPLETED" | "CONFIRMING" | "CONFIRMED" | "DEADLINE_EXPIRED" | "FORM_SHOWED" | "PARTIAL_REFUNDED" | "PREAUTHORIZING" | "PROCESSING" | "3DS_CHECKING" | "3DS_CHECKED" | "REVERSING" | "REVERSED" | "REFUNDING" | "REFUNDED" | "REJECTED" | "UNKNOWN";
            /**
             * @description Уникальный идентификатор транзакции в системе Т‑Кассы
             * @example 2304882
             */
        ...
        Cancel: {
             ...
             */
            Source?: "installment" | "BNPL";
            /** @description Идентификатор операции на стороне мерчанта. Параметр не работает для операций по СБП
        ...
        AttachCardResponse: {
             ...
             * @enum {string}
             */
            Status?: "NEW" | "FORM_SHOWED" | "3DS_CHECKING" | "3DS_CHECKED" | "AUTHORIZING" | "AUTHORIZED" | "COMPLETED" | "REJECTED";
            /**
             * @description Идентификатор рекуррентного платежа
             *
             * @example 130799909
        ...
        NotificationFiscalization: {
            ...
            Receipt?: components["schemas"]["Receipt_FFD_12-2"] | components["schemas"]["Receipt_FFD_105-2"];
...
export interface operations {
    Init: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Init_FULL"] | components["schemas"]["Init_SDK"];
            };
        };
        responses: {
            /** @description OK */
    ...
    FinishAuthorize: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["FinishAuthorize_FULL"] | components["schemas"]["FinishAuthorize_SDK"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["Without3DS"] | components["schemas"]["With3DS"] | components["schemas"]["With3DSv2APP"] | components["schemas"]["With3DSv2BRW"];
                };
            };
        };
    };
    ...
    ChargePCI: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Charge_FULL"] | components["schemas"]["Charge_SDK"];
            };
        };
        responses: {
            /** @description OK */
    ...
    GetState: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["GetState_FULL"] | components["schemas"]["GetState_SDK"];
            };
        };
        responses: {
            /** @description OK */
    ...
    AddCard: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AddCard_FULL"] | components["schemas"]["AddCard_SDK"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AddCardResponse_FULL"] | components["schemas"]["AddCardResponse_SDK"];
                };
            };
        };
    };
    ...
    GetCardList: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["GetCardList_FULL"] | components["schemas"]["GetCardList_SDK"];
            };
        };
        responses: {
            /** @description OK */
    ...
    GetQr: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["QrResponse_FULL"] | components["schemas"]["QrResponse_SDK"];
                };
            };
        };
    };
    ...
    GetQRState: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GetQRStateResponse_FULL"] | components["schemas"]["GetQRStateResponse_SDK"];
                };
            };
        };
    };
    ...
    Notification: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["NotificationPayment"] | components["schemas"]["NotificationAddCard"] | components["schemas"]["NotificationFiscalization"] | components["schemas"]["NotificationQr"];
            };
        };
        responses: {
            /** @description OK */
    ...
    GetConfirmOperation: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["by_url"] | components["schemas"]["by_email"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["response_by_url"] | components["schemas"]["response_by_email"];
                };
            };
        };
    };
